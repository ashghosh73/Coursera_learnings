...
app.layout = html.Div([
    ...
    html.H1("Automobile Statistics Dashboard",style={'textAlign': 'center', 'color': '#503D36',
    ...
    html.Div([
        ...
        dcc.Dropdown(
            ...
            placeholder='Choose a statistics report type'
        )
    ]),
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(figure=px.line(yas, x='Year',y = 'Automobile_Sales',title = "Yearly Automobiel Sales"))
  ...
  # Plot bar chart for average number of vehicles sold during the given year
    ...
    # Total Advertisement Expenditure for each vehicle using pie chart
        ...
        Y_chart4 = dcc.Graph(
            ...
            names='Vehicle_Type',
            title="Total advertisment expenditure share by vehicle type"
            ))
        
#TASK 2.6: Returning the graphs for displaying Yearly data
        return [
        html.Div(className='chart-item', children=[
            html.Div(children=Y_chart1), html.Div(children=Y_chart2)
            ], style={'display': 'flex'}),

        html.Div(className='chart-item', children=[
            html.Div(children=Y_chart3), html.Div(children=Y_chart4)
            ], style={'display': 'flex'})
                ]
    else:
        return None
